...
const MCValue = union(enum) {
    ...
    ///
    /// This MCValue is only generated by an add_with_overflow or
        ...
        switch (lhs_ty.zigTypeTag(zcu)) {
            ...
            .int => {
                ...
                if (int_info.bits <= 64) {
                    ...
                    // e.g if shifting an i48 then use sr*x (shamt_bits == 64) but increase rhs by 16
                    // and if shifting an i24 then use sr*  (shamt_bits == 32) but increase rhs by 8
